...
const SEARCH_STYLE =
  "--yn-search-bg-active:rgba(255, 255, 255, 0.96);--yn-search-bg-idle:rgba(255, 255, 255, 0);--yn-search-icon-color:#241f21;--yn-search-fill-duration:220ms;--yn-search-fill-ease:cubic-bezier(0.4, 0, 1, 1);--yn-search-icon-duration:220ms;--yn-search-icon-ease:cubic-bezier(0.4, 0, 1, 1);";
