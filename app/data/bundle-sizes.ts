...
/** 来自 `pnpm build` ESM 产物（v1.0.14，2026-08-15）。含分包时标注 total。 */
...
export const BUNDLE_SIZES: BundleSizeRow[] = [
  ...
  { id: "yn-sku-selector", importPath: "components/yn-sku-selector", sizeKb: 26.75, gzipKb: 6.75,
    note: {
          "zh-CN": "首次注册约 0.44 kB；SKU 交互代码约 26.31 kB 会按需加载",
          "en": "Initial registration ~0.44 kB; SKU interaction code ~26.31 kB loads on demand"
    } },
