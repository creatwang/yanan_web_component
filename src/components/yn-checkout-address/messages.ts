...
> = {
  en: {
    ...
    line2Helper: "Apartment, suite, unit, floor, etc. (optional)",
    ...
    whatsapp: "WhatsApp",
    whatsappPlaceholder: "Mobile number for WhatsApp",
    ...
    errorWhatsappRequired: "Enter your WhatsApp number.",
    errorWhatsappInvalid: "Enter a valid WhatsApp number (6–15 digits).",
  ...
  "zh-CN": {
    ...
    emailPlaceholder: "name@example.com",
    whatsapp: "WhatsApp",
    whatsappPlaceholder: "用于 WhatsApp 联系的手机号",
    ...
    errorWhatsappRequired: "请填写 WhatsApp 号码。",
    errorWhatsappInvalid: "请输入有效的 WhatsApp 号码（6–15 位数字）。",
