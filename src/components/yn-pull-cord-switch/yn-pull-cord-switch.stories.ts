...
const renderSwitch = (args: Args) => html`
  <yn-pull-cord-switch
  ...
  render: (args) => html`
    ...
    >
      <div>
        ...
        ${renderSwitch({ ...args, variant: "default", checked: false })}
      </div>
      <div>
        <p style="margin:0 0 8px;font-size:12px;font-weight:600;color:#666;">floema</p>
        ${renderSwitch({ ...args, variant: "floema", checked: true })}
      </div>
    </div>
  `
};
