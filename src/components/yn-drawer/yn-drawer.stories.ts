  ...
  render: (args) => html`
    <div class="yn-min-h-[520px] yn-bg-[#f5f1ea] yn-p-6">
      ...
      >
        ...
        <div slot="header" class="yn-flex yn-items-center yn-justify-between yn-gap-3 yn-w-full">
          <div class="yn-flex yn-flex-col">
            <strong class="yn-text-base yn-leading-6">我的购物车</strong>
            <span class="yn-text-xs yn-text-[#6f696b]">共 2 件商品</span>
          </div>
        </div>

        <div slot="content" class="yn-flex yn-flex-col yn-gap-3">
          <div class="yn-rounded-xl yn-bg-[#f3efe7] yn-p-3">
            <div class="yn-text-sm yn-font-bold">Lounge Chair</div>
            <div class="yn-mt-1 yn-text-xs yn-text-[#6f696b]">数量：1</div>
          </div>
          <div class="yn-rounded-xl yn-bg-[#f3efe7] yn-p-3">
            <div class="yn-text-sm yn-font-bold">Oak Side Table</div>
            <div class="yn-mt-1 yn-text-xs yn-text-[#6f696b]">数量：1</div>
          </div>
        </div>

        <div slot="footer" class="yn-flex yn-items-center yn-justify-between yn-gap-3">
          <span class="yn-text-sm yn-text-[#6f696b]">合计：EUR 368.00</span>
          <yn-button variant="default">去结算</yn-button>
        </div>
      </yn-drawer>
    </div>
  `,
